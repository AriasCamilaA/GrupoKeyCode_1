...
export const useRecipeByName = (recipeName) => {
  const RECIPE_API = `https://www.themealdb.com/api/json/v1/1/search.php?s=${recipeName}`;
  const { data, error, loading } = useFetch(RECIPE_API);
